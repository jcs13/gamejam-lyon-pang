...
var game = new Phaser.Game(800, 600, Phaser.AUTO, 'pang-example', 
		{ 
			preload: preload, 
			create: create, 
			update: update }
...
//    game.load.image('sky', 'assets/tuto/sky.png');
    game.load.image('ground2', 'assets/tuto/platform.png');
    game.load.image('star', 'assets/tuto/star.png');
    game.load.spritesheet('dude', 'assets/tuto/dude.png', 32, 48);
